...
// directory rules is organized in linkedlist,
// this func is mainly create and add new rule node to the rules linkedlist
...
// mainly is initial the directory rules linkedlist
